...
def test_create_account_valid_case(register_page):  # Указать НЕ ЗАРЕГИСТРИРОВАННЫЙ email
    ...
    register_page.submit_registration_form(firstname='Ted', lastname='Testov', email='8toov@tesst.com',
...
def test_empty_first_name(register_page):
    ...
    register_page.check_required_input_error('first_name', text_required_input_error)
